...
public class HoardingBlockStateProvider extends BlockStateProvider {
    ...
    private ResourceLocation key(Block block) {
        return Objects.requireNonNull(BuiltInRegistries.BLOCK.getKey(block), "Block is not registered!");
    }
    ...
    private void simpleBlockWithItem(Supplier<? extends Block> supplier, ModelFile model) {
        Block block = supplier.get();
        this.simpleBlock(block, model);
        this.simpleBlockItem(block, model);
    }
    ...
    private void simpleBlockItem(Supplier<? extends Block> supplier, ModelFile model) {
        Block block = supplier.get();
        this.simpleBlockItem(block, model);
    }
}
