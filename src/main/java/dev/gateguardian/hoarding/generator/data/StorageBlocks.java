...
public class StorageBlocks {
    ...
    private static final List<Entry> ENTRIES = new ArrayList<>(256);
    ...
    private static void addBotaniaEntries() {
        ...
        builder(HoardingBotaniaBlocks.ORANGE_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "orange_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.MAGENTA_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "magenta_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.LIGHT_BLUE_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "light_blue_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.YELLOW_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "yellow_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.LIME_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "lime_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.PINK_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "pink_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.GRAY_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "gray_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.LIGHT_GRAY_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "light_gray_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.CYAN_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "cyan_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.PURPLE_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "purple_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.BLUE_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "blue_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.BROWN_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "brown_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.GREEN_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "green_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.RED_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "red_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
        builder(HoardingBotaniaBlocks.BLACK_MYSTICAL_FLOWER_CRATE,
                modItem(ModIntegration.BOTANIA_MOD_ID, "black_mystical_flower"))
                .modId(ModIntegration.BOTANIA_MOD_ID).build();
    }
    ...
    private static void addArsNouveauEntries() {
        ...
        builder(HoardingArsNouveauBlocks.SOURCEBERRY_CRATE,
                modItem(ModIntegration.ARS_NOUVEAU_MOD_ID, "sourceberry"))
                .modId(ModIntegration.ARS_NOUVEAU_MOD_ID).build();
    }

    private static Item modItem(String modId, String path) {
        return BuiltInRegistries.ITEM.get(Identifier.parse(modId + ":" + path)).orElseThrow().value();
    }
    ...
    public static Builder builder(Supplier<? extends Block> storageBlock, Item sourceItem) {
        return new Builder(storageBlock, () -> sourceItem);
    }

    public static Builder builder(Block storageBlock, Supplier<? extends Item> sourceItem) {
        return new Builder(() -> storageBlock, sourceItem);
    }
